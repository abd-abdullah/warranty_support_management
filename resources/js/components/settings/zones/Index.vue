                        ...
                        <div class="card-header card-header-rose card-header-icon">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-right pr-md-0">
                                    <router-link to="/zones/form" class="btn btn-sm btn-primary mt-2">Add
                                    ...
                                    <tbody>
                                        ...
                                        >
                                            ...
                                            <td class="td-actions text-right">
                                                <router-link
                                                    :to="{ name: 'zone_form', params:{'id':zone.id}}"
                                                    type="button"
                                                    rel="tooltip"
...
export default {
    ...
    methods: {
        ...
        remove(zone){
            this.$swal("Are you sure to delete this zone?").then((result) => {
                if(result.isConfirmed === true){
                    this.$jsHelper.delete('api/v1/zones/'+zone.id).then(response =>{
                        this.$Progress.finish();
